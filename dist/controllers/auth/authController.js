...
var isAuthenticatedUserController = function (req, res) {
    var _a;
    var user = (0, jwtHelper_1.verifyUserByToken)((_a = req.body) === null || _a === void 0 ? void 0 : _a.token);
    if (user !== null) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, userModel_1.UserModel.findOne({ username: user.username })];
            case 1:
                userFounded = _c.sent();
                if ((0, encryptHelper_1.compareEncryptedStringToNormal)(userFounded === null || userFounded === void 0 ? void 0 : userFounded.password, user === null || user === void 0 ? void 0 : user.password)) {
                    token = (0, jwtHelper_1.generateJWT)(__assign({ _id: userFounded === null || userFounded === void 0 ? void 0 : userFounded._id }, user));
                    (0, responseGenerator_1.responseGenerator)(res, {
                        url: req.url,
                        status: 200,
                        result: true,
                        data: __assign(__assign({}, userFounded), { token: token })
                    });
                }
                else {
                    (0, responseGenerator_1.responseGenerator)(res, {
...
var logoutUserController = function (req, res) {
    (0, responseGenerator_1.responseGenerator)(res, {
        url: req.url,
        status: 200,
        result: true,
