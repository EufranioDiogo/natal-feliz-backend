...
var createUserController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        ...
        try {
            newUser_1 = new userModel_1.UserModel(user);
            userModel_1.UserModel
                .create(newUser_1)
                .then(function () {
                console.log('Creation ', newUser_1);
                var token = (0, jwtHelper_1.generateJWT)(__assign({ _id: newUser_1 === null || newUser_1 === void 0 ? void 0 : newUser_1._id }, user));
                res.json((0, responseGenerator_1.responseGenerator)(res, {
                    url: req.url,
                    status: 200,
                    result: true,
                    data: __assign(__assign({}, newUser_1), { token: token })
                }));
            })
                .catch(function (err) {
                console.log(err);
